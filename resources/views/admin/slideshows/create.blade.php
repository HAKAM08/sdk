...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Add New Slideshow</h1>
            ...
            <form action="{{ route('admin.slideshows.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="order" name="order" value="{{ old('order', 1) }}" min="1" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="image">Slideshow Image <span class="text-danger">*</span></label>
                ...
                <button type="submit" class="btn btn-primary">Save Slideshow</button>
            </form>
        </div>
    </div>
</div>
