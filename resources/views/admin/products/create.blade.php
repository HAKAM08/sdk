                                    ...
                                    @if ($category->children->count() > 0)
                                        <div class="ms-4">
                                            @foreach ($category->children as $childCategory)
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="category_{{ $childCategory->id }}" name="categories[]" value="{{ $childCategory->id }}" {{ in_array($childCategory->id, old('categories', [])) ? 'checked' : '' }}>
