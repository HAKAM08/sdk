    ...
    <div class="flex flex-col md:flex-row gap-8">
        ...
        <div class="md:w-1/4">
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('user.dashboard') }}" class="block py-2 px-4 bg-blue-100 text-blue-700 rounded-md font-medium">
                            Dashboard
                        </a>
                    </li>
                    <li>
        ...
        <div class="md:w-3/4">
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <p class="text-gray-600 mb-4">From your account dashboard you can view your recent orders, manage your shipping and billing addresses, and edit your password and account details.</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="{{ route('user.orders') }}" class="text-blue-700 hover:text-blue-900">View All</a>
                </div>
